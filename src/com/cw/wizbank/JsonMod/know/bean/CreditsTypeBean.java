...
public class CreditsTypeBean {
	...
	public boolean getCty_manual_ind() {
	...
	public boolean getCty_deleted_ind() {
	...
	public boolean getCty_relation_total_ind() {
	...
	public boolean getCty_default_credits_ind() {
