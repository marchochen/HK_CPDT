...
public class RequestToken {
	 ...
	 * <br>
	 * <br>
	 * <b>NOTE: Delimiters only apply to <code>TOKEN_VALUE</code> type
	 * tokens.</b>
	 */
	private Vector mDelimiters = null;

	/**
	 * Attempts to interpret the value as a valid token and determine it's type. <br>
	 * <strong>NOTE: This method does not differentiate between data model and
	 * data model element dot-notation bindings. All 'strings' are considered
	 * data model elements.</strong> This method may throw the following Java
	 ...
	 * 
	 * @param iName
	 *            The name of the requested delimiter.
	 * 
	 ...
	 * 
	 * @param iIndex
	 *            The index of the requested delimiter.
	 * 
	...
	public String getDelimiterValueAt(int iIndex) {
		...
		if (mDelimiters != null) {
			if (iIndex < mDelimiters.size()) {
				RequestDelimiter del = (RequestDelimiter) mDelimiters.elementAt(iIndex);
	 ...
	 *            The index of the requested delimiter.
	 * 
	 * @return The the delimiter at the specified index or <code>null</code> if
	...
	/**
	 * Parses all delimiters from the identified string. This method may throw
	 * the following Java <code>RuntimeException</code>:
	 * <ul>
	 ...
	 *            String to parse
	 * 
	 * @return An integer value that indicates where the next delimiter should
	 *         start
	 * 
	 */
