...
public abstract class DMElement implements Serializable {
	...
	/**
	 * Stores whether or not the value held in this element was set by the SCO
	 * or not.
	 */
    ...
    *         String</code>
	 ...
	 * 
	 * @param iSetBySCO
	 *            <code>true</code> if value is set by SCO.
	 */
				...
				if (mInitialized) {
					...
					if (mDelimiters != null) {
						for (int i = 0; i < mDelimiters.size(); i++) {
							DMDelimiter del = (DMDelimiter) mDelimiters.elementAt(i);
