...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    _localeDirectory 	= (config.localeDirectory!=null?config.localeDirectory:"../static/js/flexPaper/locale/");
    ...
    window[instance] = flashembed(id, {
        ...
        FitPageOnLoad 			: (config.FitPageOnLoad!=null)?config.FitPageOnLoad:true,
        FitWidthOnLoad 			: (config.FitWidthOnLoad!=null)?config.FitWidthOnLoad:true,
        ...
        InitViewMode 			: (config.InitViewMode!=null)?config.InitViewMode:'Portrait', //'Portrait':单页; 'TwoPage':双页
        ...
        UIConfig                : ((config.UIConfig!=null)?config.UIConfig:'../static/js/flexPaper/UI_Zine.xml'),  // FlexPaper Zine parameter
        ...
        localeChain 			: (config.localeChain!=null)?config.localeChain:"en-us",
