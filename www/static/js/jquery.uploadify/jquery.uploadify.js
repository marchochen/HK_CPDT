		...
		init : function(options, swfUploadOptions) {
			return this.each(function() {
				...
				var settings = $.extend({
					...
					width           : 82,                // The width of the browse button
				...
				if (flashInstalled) {
					...
					$button.html('<span class="uploadify-button-text" style="text-shadow:none;line-height:34px;">' + settings.buttonText + '</span>')
					.css({
						'height'      : settings.height + 'px',
