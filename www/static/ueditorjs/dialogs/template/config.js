...
var templates = [
    ...
    { 
    	"pre":"pre4.png",
    	'title':'汇思模块',
    	'preHtml':'<h1>这是图</h1><img src="images/zhi.png"/>',
    	'html':'<p style="display: inline-block;position: relative;width:100%;height:500px;background:url(http://127.0.0.1:8889/ueditor/dialogs/template/images/1.jpg);"><span style="position: relative;padding-top: 45px;background: rgba(255,255,2,0.5);display:block;width:100%;height:150px;color:#fff;margin-top:10%;text-align: center;font-size:24px;"><img style="display:block;z-index:9;margin: 0 auto;margin-top:-102px;border-radius: 100%;width100px;height:100px;" src="http://127.0.0.1:8889/ueditor/dialogs/template/images/teacher02.jpg"/><span style="margin-top:20px;">dsadsada</span><span style="display:block;margin-top:10px;color:#fff;font-size:30px;font-weight: 900;">梦想总是要有的万一实现了那</span><spna style="display:block;margin-top:10px;">架构师</span></span></p>'
    },
    {
    	"pre":"pre4.png",
    	'title':'汇思模块',
    	'preHtml':'<h1>这是图</h1><img src="images/zhi.png"/>',
    	'html':'<p style="height:300px;width:50%;float:left;background:yellow;">'
    	+'<img style="margin:0 auto;display:block;border-radius:50%;" src="http://127.0.0.1:8889/ueditor/dialogs/template/images/teacher02.jpg"/>'
    	+'<span>爱谁</span>'
    	+'</p>'
    	+'<p style="height:300px;width:50%;float:left;background:blue;">'
    	+'<span>爱谁谁</span>'
    	+'</p>'
    }
];