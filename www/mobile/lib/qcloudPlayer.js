...
function() {
    return function(e) {
        ...
        var y = c.MSG;
        var m = t.TcPlayer = function(e) {
            v(t, e);
            function t(r, n) {
                f(this, t);
                var o = g(n);
                var s = i.IS_MOBILE ? false: true;
                var a = {
                    owner: r,
                    videoSource: o,
                    src: o.curUrl,
        ...
        function _(e, t, r) {
            ...
            o = void 0;
            if (!r) {
                r = i.IS_MOBILE ? ["m3u8", "mp4"] : ["rtmp", "flv", "m3u8", "mp4"]
            }
    ...
    function(e, t) {
        ...
        var c = t.IS_ANDROID = /Android/i.test(r);
        var p = t.ANDROID_VERSION = function() {
        ...
        var h = t.IS_OLD_ANDROID = c && /webkit/i.test(r) && p < 2.3;
        var f = t.IS_NATIVE_ANDROID = c && p < 5 && i < 537;
        var d = t.IS_FIREFOX = /Firefox/i.test(r);
        var v = t.IS_EDGE = /Edge/i.test(r);
        var y = t.IS_CHROME = !v && /Chrome/i.test(r);
        var m = t.IS_IE8 = /MSIE\s8\.0/.test(r);
        var g = t.IS_IE9 = /MSIE\s9\.0/.test(r);
        var b = t.IS_IE = /MSIE\s([\d.]+)/.test(r);
        var _ = t.TOUCH_ENABLED = !!("ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch);
        var w = t.BACKGROUND_SIZE_SUPPORTED = "backgroundSize" in document.createElement("video").style;
        var S = t.HASVIDEO = !!document.createElement("video").canPlayType;
        var E = t.IS_X5TBS = /TBS\/\d+/i.test(r);
        var M = t.IS_MQQB = !E && /MQQBrowser\/\d+/i.test(r);
        var O = t.IS_MOBILE = c || l;
        var k = t.IS_FILE_PROTOCOL = /file:/.test(location.protocol)
    },
    function(e, t) {
        "use strict";
        t.__esModule = true;
    ...
    function(e, t, r) {
        ...
        var d = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitCancelFullScreen", "webkitfullscreenchange", "webkitfullscreenerror"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]];
        var v = d[0];
        var y = void 0;
    ...
    function(e, t, r) {
        ...
        var L = t.Player = function() {
            function e(t) {
                ...
                c.sub("*", "*", x.bind(this, this.handleMsg), this);
                r = I.get(r);
                this.render(r)
            }
            ...
            e.prototype.size = function r(e, t, n) {
                ...
                this.video.height("86%");
                this.width = o;
                this.height = s
            };
            e.prototype.setup = function n() {
                this.__handleEvent = x.bind(this, this.handleEvent);
                if (C.IS_MOBILE) {
                ...
                I.loadScript("//pingjs.qq.com/h5/stats.js?v2.0.2", null, {
                    name: "MTAH5",
                    sid: "500376528",
                    cid: "500383222"
                })
            ...
            e.prototype.handleMsg = function a(e) {
                ...
                case T.Play:
                    ...
                    I.addClass(this.el, "vcp-playing");
                    if (this.video.type() == x.VideoType.RTMP) {
                        this.__wait = true;
                        this.loading.show()
                    }
                    I.on(this.el, "mousemove", this.__handleEvent);
                    break;
                case T.TimeUpdate:
                    if (this.__wait) {
                        this.__wait = false;
                    ...
                    break;
                case T.Pause:
                    I.off(this.el, "mousemove", this.__handleEvent);
                    I.removeClass(this.el, "vcp-playing");
                    break;
                case T.Ended:
                    I.off(this.el, "mousemove", this.__handleEvent);
                    ...
                    break;
                case T.MetaLoaded:
                    if (this.options.autoplay && this.video.type() == x.VideoType.RTMP) {
                        this.__wait = true;
                        this.loading.show()
                    } else {
                        this.loading.hide()
                ...
                case T.FullScreen:
                    var t = this;
                    setTimeout(function() {
                        I.toggleClass(t.el, "vcp-fullscreen", e.detail.isFullscreen)
                    },
                    0);
                    break;
                case T.Error:
    ...
    function(e, t, r) {
        ...
        var b = function(e) {
            ...
            t.prototype.togglePlay = function w() {
                ...
                if (this.options.live && e && this.playState == h.PlayStates.IDLE && !this.metaDataLoaded) {
                    this.player.load()
                } else {
                    if (this.paused()) {
                        this.play()
            ...
            t.prototype.fullscreen = function x(e) {
                return u.doFullscreen(this.player, e, this.owner)
            };
            t.prototype.load = function I(e, t) {
                this.pub({
                    type: c.MSG.Load,
                    src: this,
    ...
    function(e, t, r) {
        ...
        var _ = function(e) {
            ...
            t.prototype.duration = function x() {
                return this.__duration
            };
            t.prototype.mute = function I(e) {
    ...
    function(e, t, r) {
        ...
        function() {
            ...
            function r(e, t, r, n) {
                ...
                l = a && "-" + a + "-" || "";
                return h[i] || (c.insertRule("@" + l + "keyframes " + i + "{0%{opacity:" + s + "}" + o + "%{opacity:" + e + "}" + (o + .01) + "%{opacity:1}" + (o + t) % 100 + "%{opacity:" + e + "}100%{opacity:" + s + "}}", c.cssRules.length), h[i] = 1),
                i
            }
            function n(e, t) {
                var r, n, i = e.style;
                    ...
                    if (i(o, {
                        ...
                        function d() {
                            ...
                            for (var e = 0; e < n.lines; e++) {
                                s = Math.max(1 - (a + (n.lines - e) * f) % p * h, n.opacity),
...
/*  |xGv00|10f1720c87b44ac6de4bedc55fe9807f */
