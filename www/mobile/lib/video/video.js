...
ControlBar.prototype.options_ = {
  loadEvent: 'play',
  children: ['playToggle', 'progressControl', 'currentTimeDisplay', 'timeDivider', 'durationDisplay',  'liveDisplay', 'remainingTimeDisplay', 'customControlSpacer', 'playbackRateMenuButton', 'chaptersButton', 'subtitlesButton', 'captionsButton','volumeMenuButton', 'fullscreenToggle']
};
...
//    debugger;
//    var play_width = tag.getAttribute('width');
    ...
    if(context_text != undefined && context_text != ""){ //循环
    	var marquee  = document.createElement("marquee");
    	marquee.className = 'vjs-marquee';
    	marquee.setAttribute("direction","left");
    	marquee.innerHTML = context_text;
