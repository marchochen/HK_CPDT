    ...
    ["$timeout", "VG_STATES", function ($timeout, VG_STATES) {
        return {
            ...
            template: function (elem, attrs) {
                return attrs.vgTemplate || '<div class="controls-container" ng-mousemove="onMouseMove()" ng-class="animationClass" ng-transclude></div>';
            },
            scope: {
                vgAutohide: "=?",
                vgAutohideTime: "=?"
...
angular.module("com.2fdevs.videogular.plugins.controls")
    ...
    [function () {
        return {
            ...
            scope: {},
            template: function (elem, attrs) {
                return attrs.vgTemplate || '<button class="iconButton" ng-click="onClickFullScreen()" ng-class="fullscreenIcon" aria-label="Toggle full screen" type="button"> </button>';
            },
            link: function (scope, elem, attr, API) {
...
angular.module("com.2fdevs.videogular.plugins.controls")
    ...
    ["VG_STATES", function (VG_STATES) {
        return {
            ...
            scope: {},
            template: function (elem, attrs) {
                return attrs.vgTemplate || '<button class="iconButton" ng-click="onClickPlayPause()" ng-class="playPauseIcon" aria-label="Play/Pause" type="button"></button>';
            },
            link: function (scope, elem, attr, API) {
    ...
    [function () {
        return {
            ...
            templateUrl: function (elem, attrs) {
                return attrs.vgTemplate || '<button class="playbackValue iconButton" ng-click="onClickPlayback()">{{playback}}x</button>';
            },
            link: function (scope, elem, attr, API) {
                scope.playback = '1';
    ...
    .directive("vgScrubBarCuePoints", [
        function () {
            return {
                ...
                require: "^videogular",
                template: function (elem, attrs) {
                    return attrs.vgTemplate || '<div class="cue-point-timeline">' +
    ...
    .directive("vgScrubBarThumbnails", ["VG_UTILS",
        function (VG_UTILS) {
            return {
                ...
                require: "^videogular",
                template: function (elem, attrs) {
                    return attrs.vgTemplate || '<div class="vg-thumbnails" ng-show="thumbnails" ng-style="thumbnailContainer">' +
    ...
    .directive("vgScrubBar", ["VG_STATES", "VG_UTILS",
        function (VG_STATES, VG_UTILS) {
            return {
                ...
                transclude: true,
                template: function (elem, attrs) {
                    return attrs.vgTemplate || '<div role="slider" ' +
...
angular.module("com.2fdevs.videogular.plugins.controls")
    ...
    [function () {
        return {
            ...
            require: "^videogular",
            template: function (elem, attrs) {
                return attrs.vgTemplate || '<button type="button" class="iconButton" ng-class="muteIcon" ng-click="onClickMute()" ng-focus="onMuteButtonFocus()" ng-blur="onMuteButtonLoseFocus()" ng-mouseleave="onMuteButtonLeave()" ng-keydown="onMuteButtonKeyDown($event)" aria-label="Mute"></button>';
            },
            link: function (scope, elem, attr, API) {
                var isMuted = false;
                var UP = 38;
...
angular.module("com.2fdevs.videogular.plugins.controls")
    ...
    ["VG_UTILS", function (VG_UTILS) {
        return {
            ...
            require: "^videogular",
            template: function (elem, attrs) {
                return attrs.vgTemplate || '<div class="verticalVolumeBar">\
