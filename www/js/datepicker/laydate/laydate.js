;!function (a) {
    ...
    a.laydate = function (b) {
        ...
        }), c.valid = !c.hasClass(f.thisDay, h[1]), c.ymd = f.ymd, h.year.value = c.ymd[0] + " ", h.month.value = month(Number(c.digit(c.ymd[1] + 1))) + "", c.each(h.mms, function (a, b) {
        ...
        var a, b = [], f = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], h = {}, i = d[e]("table"), j = d[e]("thead");
        return j.appendChild(d[e]("tr")), h.creath = function (a) {
            var b = d[e]("th");
           

            b.innerHTML = f[a].toUpperCase(), j[g]("tr")[0].appendChild(b), b = null
    ...
    //document.getElementsByClassName('top-ri')[0].innerHTML=da.getDate()
        ...
        c.addClass(d.body, "laydate_body"), h.tds = b("#laydate_table td"), h.mms = b("#laydate_ms span"), h.year = b("#laydate_y"), h.month = b("#laydate_m"), c.each(b(e.box + " .laydate_ym"), function (a, b) {
            ...
            c.on(b, "click", function (a) { 
                ...
                document.getElementsByClassName("top-ri")[0].innerHTML=b.innerHTML
                document.getElementsByClassName("top-nian")[0].innerHTML=b.getAttribute("y")
                console.log(b.getAttribute("m"))
                document.getElementsByClassName("top-yue")[0].innerHTML= month(Number(b.getAttribute("m")))
            ...
            console.log(laydate.now(0, c.options.format).split("-"))
            document.getElementsByClassName("top-nian")[0].innerHTML=laydate.now(0, c.options.format).split("-")[0]
            document.getElementsByClassName("top-ri")[0].innerHTML=laydate.now(0, c.options.format).split("-")[2]

            document.getElementsByClassName("top-yue")[0].innerHTML= month(Number(laydate.now(0, c.options.format).split("-")[1]))
