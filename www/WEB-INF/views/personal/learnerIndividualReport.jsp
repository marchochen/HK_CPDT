	    	   ...
	    	   var downloadPath ='';
	    	    layer.open({
	    	          ...
	    	          success: function(layero, index){
	    	                $.ajax({
	    	                    url : '${ctx}/app/cpdIndividualReport/personalIndividualReportPdf',
	    	                    type : 'POST',
	    	                    data:{
	    	                    	"period":period,
	    	                    	"cghiCtIdArray":cghiCtIdArray,
	    	                    	"exportUserId":${usrEntId},
                        ...
                        <td class="wzb-form-control">
                            <table>
                                <tbody  id="tableContent">
	                                <c:forEach items="${cpdType}"  var="cpdTypes" varStatus="status">
                                    <tr>
                                        <td><input name="cghi_ct_id" value="${cpdTypes.ct_id }" type="radio" <c:if test="${status.index == 0 }">checked="checked" </c:if>>
