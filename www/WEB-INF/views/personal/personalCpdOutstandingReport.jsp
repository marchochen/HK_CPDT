...
<script type="text/javascript">
         $(document).ready(function(){
	      ...
	      function reloadTable() {
	            ...
	            $.ajax({
	                url : '${ctx}/app/cpdOutstandingReport/getcpdTypeRegHistory?period='+period,
	                dataType : 'json',
                    type : 'POST',
	       ...
	       function submitRes(){
	    	   ...
	    	   //var url=  '${ctx}/app/cpdOutstandingReport/cpdOutstandingReportExcel?period='+period+'&cghiCtIdArray='+cghiCtIdArray+'&exportUser='+exportUser+'&usertIdArray='+usertIdArray;
	    	   //wb_utils_open_win(url,'','width=450,height=250');
	    	   ...
	    	   var downloadPath ='';
	    	    layer.open({
	    	          ...
	    	          success: function(layero, index){
	    	                $.ajax({
	    	                    url : '${ctx}/app/cpdOutstandingReport/cpdOutstandingReportExcel',
	    	                    type : 'POST',
	    	                    //data:  $('#formCondition').serialize(),
	    	                    data:{"period":period,"cghiCtIdArray":cghiCtIdArray,"exportUser":exportUser,"usertIdArray":usertIdArray},
	    	                    dataType : 'json',
	    	                    traditional : true,
	    	                    success : function(data) {
	...
	<div id="main" class="xyd-main clearfix">
        ...
        <div class="xyd-article">
            <div role="tabpanel" class="wzb-tab-3">
                <div class="wzb-title-12"><lb:get key="label_cpd.label_core_cpt_d_management_127" /></div>
