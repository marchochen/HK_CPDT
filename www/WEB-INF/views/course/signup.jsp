...
<script type="text/javascript">
	...
	$(function() {
		...
		course = $(".wbtabcont").table({
			url : '${ctx}/app/course/getMyCourse',
			colModel : colModel,
			rp : globalPageSize,
			params : {
				appStatus : appStatus
	...
	var colModel = [ {
		format : function(data) {
			...
			var schar_itm_desc= data.item.itm_desc ? data.item.itm_desc : "";
            var schar_str="";  
            var schar_len=0;  
            var schar;  
            var re = /[^\u4e00-\u9fa5]/;  
...
<p>
    <a class="wzb-link01" href="${ctx}/app/course/detail/{{>parent_id}}{{if app_tkh_id}}?tkhId={{>app_tkh_id}}{{/if}}" title="" >{{>parent_title}}</a>
...
<dl class="wzb-list-6">
	 ...
	 <dt>
		  ...
		  <div class="offheight clearfix"><div class="offwidth"><span class="color-gray999"><lb:get key="course_type"/>：</span> {{>itm_type}}</div> <div class="offwidth"><span class="color-gray999"><lb:get key="course_progress"/>：</span><div class="progress progress-xs" style="width:60%;"><div class="progress-bar progress-bar-orange" style="width:{{if progress != 0}}{{>progress}}{{else}}10{{/if}}px"></div></div></div></div>
	...
	<div class="xyd-wrapper">
		<div id="main" class="xyd-main clearfix">
			<div class="xyd-sidebar">
                <h3 class="wzb-title-4 skin-bg"><lb:get key="course_signup"/> <i class="fa fa-sanzuo fa-caret-up"></i></h3>
                
                <h3 class="wzb-title-7 skin-color"><lb:get key="course_type"/></h3>
                
                <ul class="wzb-list-17" id="course">
                    <li data=""><a class="cur" href="javascript:;" title=""><lb:get key="status_all"/> </a></li>
                    <li data="selfstudy"><a href="javascript:;" title=""><lb:get key="selfstudy"/> </a></li>
                    <li data="classroom"><a href="javascript:;" title=""><lb:get key="classroom"/> </a></li>
                ...
                <div class="wzb-model-8">
                    <dl class="wzb-list-4" id="isCompulsory">
                       <%--  <dt><lb:get key="condition"/>：</dt>
                        ...
                        <dd><a href="javascript:;" title="" data="1"><i class="fa margin-right10 fa-circle-thin"></i><lb:get key="recommend_course"/></a></dd>
                        <dd><a href="javascript:;" title="" data="0"><i class="fa margin-right10 fa-circle-thin"></i><lb:get key="recommend_myself"/></a></dd> --%>
                    </dl> 
                </div>
			...
			<div class="xyd-article">
					<div role="tabpanel" class="wzb-tab-3">
                        ...
                        <ul class="nav nav-tabs wblearn" role="tablist">
                            <li role="presentation" id="inprogeress" data="I" class="active"><a href="#waiting" aria-controls="waiting" role="tab" data-toggle="tab"><lb:get key="status_inprogress"/></a></li>
                            <li role="presentation" id="completed" data="C"><a href="#refusal" aria-controls="refusal" role="tab" data-toggle="tab"><lb:get key="status_completed"/></a></li>
                            <li role="presentation" id="notIAndC" data="notIAndC"><a href="#passing" aria-controls="passing" role="tab" data-toggle="tab"><lb:get key="status_others"/></a></li>
                        </ul>
