...
<script type="text/javascript">
	...
	var itemType;
	var appStatus;
	var isCompulsory = getUrlParam('r');
	var len = 75;
	$(function() {
		course = $("#wbtabcont").table({
			url : '${ctx}/app/course/recommendJson',
			colModel : colModel,
			rp : globalPageSize,
			showpager : 10,
			hideHeader : true,
			...
			onSuccess : function(data){
				if(data.params.params[0].value == 1){
					$(".wblearn>li:eq(1)").addClass('active').siblings().removeClass('active');
				}
			}
		})
	...
	var colModel = [ {
		format : function(data) {
			...
			var p = {
				...
				itm_type : fetchLabel(data.item.itm_type.toLowerCase()),
...
<dl class="wzb-list-6">
	 ...
	 <dt>
		  ...
		  <div class="offheight clearfix"><div class="offwidth"><span class="color-gray999"><lb:get key="course_type"/>：</span>{{>itm_type}}</div> <div class="offwidth"><span class="color-gray999"><lb:get key="course_status"/>：</span>{{>status}}</div></div>
	...
	<div class="xyd-wrapper">
		<div id="main" class="xyd-main clearfix">
			<div class="xyd-sidebar">
                <h3 class="wzb-title-4 skin-bg"><lb:get key="recommend_course"/> <i class="fa fa-sanzuo fa-caret-up"></i></h3>
                <%-- 
			...
			<div class="xyd-article">
					<div role="tabpanel" class="wzb-tab-3">
                        ...
                        <ul class="nav nav-tabs wblearn" role="tablist">
                            <li data="" role="presentation" class="active"><a href="#waiting" aria-controls="waiting" role="tab" data-toggle="tab"><lb:get key="recommend_all_course"/></a></li>
                        ...
                        <div class="tab-content">
                             <div class="wbtabcont" id="wbtabcont"></div>
                        </div>
                    </div> <!-- wzb-tab-3 end -->
			</div> <!-- xyd-article End-->
