...
<input type="hidden" name="belong_module" value="FTN_AMD_CPT_D_MGT"/>
    ...
    <ol class="breadcrumb wzb-breadcrumb">
        ...
        <li class="active"><a href="/app/admin/cpdRegistrationMgt/list"><lb:get key="global.FTN_AMD_CPT_D_LICENSE_LIST" /></a> </li>
    ...
    $(function() {
         searchTb = $("#cpdAwardHoursLog_list").table({
            url : '${ctx}/app/admin/cpdRegistrationMgt/listJsonLog',
            dataType : 'json',
            colModel : colModel,
            rp : 10,
            showpager : 3,
