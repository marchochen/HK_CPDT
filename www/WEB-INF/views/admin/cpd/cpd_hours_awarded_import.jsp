...
function cpdHoursAwardedImportGetInstr(){
    url = wb_utils_controller_base + 'admin/cpdImportAwardedHours/toCPDHoursAwaededImportInstr?isExcludes=true';
    wbUtilsOpenWin(url, '');
}
...
function cpdAwardImportExec(lang){
    ...
    if (_txtFileName.substring(_txtFileName.lastIndexOf('.')+1).toLowerCase() != 'xls' && _txtFileName.substring(_txtFileName.lastIndexOf('.')+1).toLowerCase() != 'xlsx')  {
        ...
        document.getElementById("frmXml").action= wb_utils_controller_base +"admin/cpdImportAwardedHours/filesUpload";
