...
window.onload = function(){
	...
	if('${pageExportUser}' != "") {		// 学员
		...
		$("input[name='exportUser']").each(function(){
			if(this.value == arr_exportUser[0]) {
				...
				if(arr_exportUser[0] == "0" && arr_exportUser[1] != "") {
					$("input[name='includeDelUser']").attr("checked", true);
				} else if(arr_exportUser[0] == "1") {
					$("input[name='includeDelUser']").attr("disabled", true);
					for(var i=1; i<arr_exportUser.length; i++) {
						$("#exportUserIds").append("<option value="+arr_exportUser[i]+">"+arr_exportUserIdsText[i-1]+"</option>")
					}
				} else {
					$("input[name='includeDelUser']").attr("disabled", true);
					for(var i=1; i<arr_exportUser.length; i++) {
						$("#exportGroupIds").append("<option value="+arr_exportUser[i]+">"+arr_exportUserIdsText[i-1]+"</option>")
					}
				}
			}
		});
		...
		$("input[name='exportCourse']").each(function(){
			if(this.value == arr_exportCourse[0]) {
				...
				if(arr_exportCourse[0] == "1") {
					for(var i=1; i<arr_exportCourse.length; i++) {
						$("#exportCourseIds").append("<option value="+arr_exportCourse[i]+">"+arr_exportCourseIdsText[i-1]+"</option>")
					}
				} else if(arr_exportCourse[0] == "2") {
					for(var i=1; i<arr_exportCourse.length; i++) {
						$("#exportCatalogIds").append("<option value="+arr_exportCourse[i]+">"+arr_exportCourseIdsText[i-1]+"</option>")
					}
				}
			}
		});
	...
	laydate(time_end); */
	 $('#view_report_btn').click(function(){
         ...
         $("#pageExportCourseIds").val(page_exportCourse);
...
<body>
      <form id="formCondition" name="formCondition" action="${ctx}/app/admin/learnerReport/getLearnerReportByUser" onsubmit="preSubmit()" method="post">
		...
		<input type="hidden" name="pageExportUser" id="pageExportUser" value=""/>
        <input type="hidden" name="pageExportUserIds" id="pageExportUserIds" value=""/>
		<input type="hidden" name="pageExportUserIdsText" id="pageExportUserIdsText" value=""/>
		<input type="hidden" name="pageExportCourse" id="pageExportCourse" value=""/>
        <input type="hidden" name="pageExportCourseIds" id="pageExportCourseIds" value=""/>
		<input type="hidden" name="pageExportCourseIdsText" id="pageExportCourseIdsText" value=""/>
		<input type="hidden" name="pageCourseType" id="pageCourseType" value=""/>
		<input type="hidden" name="pageAppnStartDatetime" id="pageAppnStartDatetime" value=""/>
		<input type="hidden" name="pageAppnEndDatetime" id="pageAppnEndDatetime" value=""/>
		<input type="hidden" name="pageAttStartTime" id="pageAttStartTime" value=""/>
		<input type="hidden" name="pageAttEndTime" id="pageAttEndTime" value=""/>
		<input type="hidden" name="pageAppStatus" id="pageAppStatus" value=""/>
		<input type="hidden" name="pageCourseStatus" id="pageCourseStatus" value=""/>
		<input type="hidden" name="pageResultDataStatistic" id="pageResultDataStatistic" value=""/>
		<input type="hidden" name="pageIsExportDetail" id="pageIsExportDetail" value=""/>
		<input type="hidden" name="pageUserInfo" id="pageUserInfo" value=""/>
		<input type="hidden" name="pageCourseInfo" id="pageCourseInfo" value=""/>
		<input type="hidden" name="pageOtherInfo" id="pageOtherInfo" value=""/>
...
<%-- 
                                <label class="wzb-form-checkbox">
                                    <input name="courseType" value="2" type="hidden"><lb:get key="label_rp.label_core_report_55"/>
                                </label>

                                <label class="wzb-form-checkbox">
                                    <input name="courseType" value="3" type="hidden"><lb:get key="label_rp.label_core_report_56"/>
                                </label>  --%>
							<!-- 
                                <label class="wzb-form-checkbox">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <label class="wzb-form-checkbox">
                                                    <input name="userInfo" value="staffNo" type="checkbox"><lb:get key="label_rp.label_core_report_168"/>
                                                </label>
                                            </td>
                                        </tr>
                                    </tbody>
              ...
              <%--   <div>
                ...
                <div class="wzb-bar">
                    ...
                    <input id="save_report_btn" style="" name="" value="<lb:get key="button_save"/>"  onclick="save();javascript:mgt_rpt.ins_rpt_prep_popup_jsp(document.formCondition,'','${prof.usr_ent_id}','LEARNER','${label_lan}');" type="button" class="btn wzb-btn-blue margin-right10 wzb-btn-big">                     
