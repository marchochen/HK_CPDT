...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="lang_ch">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_grad_record_desc">學員完成課程的總體情況</xsl:with-param>
	...
	<xsl:template name="lang_gb">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_grad_record_desc">学员完成课程的总体情况</xsl:with-param>
	...
	<xsl:template name="lang_en">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_tracking_rpt_desc">Detail tracking statistics of learners in online learning content</xsl:with-param>
	...
	<xsl:template name="content">
		...
		<xsl:call-template name="wb_ui_nav_link">
			<xsl:with-param name="text">
						...
						<span class="NavLink">&#160;&gt;&#160;<xsl:value-of select="$lab_performance"/>
						</span>
			</xsl:with-param>
		</xsl:call-template>
		<table>
			...
			<xsl:if test="/applyeasy/item/@run_ind = 'true'">
				<xsl:call-template name="template">
