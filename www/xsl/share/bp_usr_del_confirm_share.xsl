...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="lang_ch">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_title">批量刪除用戶 - 第二步：確認</xsl:with-param>
			<xsl:with-param name="lab_error_title">批量刪除用戶 - 錯誤</xsl:with-param>
	...
	<xsl:template name="lang_gb">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_title">批量删除用户 - 第二步：确认</xsl:with-param>
			<xsl:with-param name="lab_error_title">批量删除用户 - 错误</xsl:with-param>
	...
	<xsl:template name="lang_en">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_title">Batch delete user – Step 2: Confirmation</xsl:with-param>
			<xsl:with-param name="lab_error_title">Batch delete user - Error</xsl:with-param>
