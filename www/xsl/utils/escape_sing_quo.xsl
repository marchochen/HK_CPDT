...
<!-- ===============================================================-->
<xsl:template name="escape_sing_quo">
	...
	<xsl:choose>
		...
		<xsl:otherwise>
			...
			<xsl:call-template name="escape_sing_quo"><xsl:with-param name="my_right_value"><xsl:value-of select="$aft_value"/></xsl:with-param><xsl:with-param name="my_left_value"><xsl:value-of select="$my_left_value_test"/></xsl:with-param></xsl:call-template>
		</xsl:otherwise>
	</xsl:choose>
</xsl:template>
</xsl:stylesheet>
