...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="lang_ch">
		<xsl:call-template name="content">
		   <xsl:with-param name="lab_g_form_btn_ok">確定</xsl:with-param>
			<xsl:with-param name="lab_title">批量刪除用戶 - 結果</xsl:with-param>
			...
			<xsl:with-param name="lab_failed">删除過程失敗</xsl:with-param>
	...
	<xsl:template name="lang_gb">
		<xsl:call-template name="content">
		   <xsl:with-param name="lab_g_form_btn_ok">确定</xsl:with-param>
			<xsl:with-param name="lab_title">批量删除用户结果 - 结果</xsl:with-param>
			...
			<xsl:with-param name="lab_failed">删除过程失败</xsl:with-param>
			<xsl:with-param name="lab_reason">原因</xsl:with-param>
	...
	<xsl:template name="lang_en">
	   ...
	   <xsl:with-param name="lab_g_form_btn_ok">OK</xsl:with-param>
			<xsl:with-param name="lab_title">Batch delete user - result</xsl:with-param>
			...
			<xsl:with-param name="lab_failed">Batch delete process failed to complete. </xsl:with-param>
