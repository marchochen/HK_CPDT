...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:import href="import_user_report.xsl"/>
	<!-- =============================================================== -->
			...
			<xsl:choose>
				...
				<xsl:when test="$in_lang = 'zh-hk'">
					<xsl:call-template name="que">
						...
						<xsl:with-param name="field">type_desc</xsl:with-param>
						<xsl:with-param name="title">匯入填充題－說明</xsl:with-param>
						<xsl:with-param name="type">填充題</xsl:with-param>
					</xsl:call-template>
				</xsl:when>
				<xsl:otherwise>
					<xsl:call-template name="que">
		...
		<xsl:choose>
			<xsl:when test="$in_lang = 'zh-cn'">
				<table width="95%" align="center" class="instr_table">
					...
					<tr>
						<td nowrap="nowrap" align="center">2</td>
						<td>登录学习平台并选择“<b>用户管理</b> > <b>导入</b>”。只有具有特定管理员权限的用户才有该功能。</td>
					</tr>
					<tr>
						<td nowrap="nowrap" align="center">3</td>
					...
					<tr>
						...
						<td>如果文件中有多条用户名相同的记录，该用户的信息将会以最后一条记录的信息为准。</td>
					</tr>
				</table>
				<br/>
				<table width="95%" align="center" class="instr_table">
			...
			<xsl:when test="$in_lang = 'zh-hk'">
				<table width="95%" align="center" class="instr_table">
					...
					<tr>
						<td nowrap="nowrap" align="center">2</td>
						<td>登錄學習平台並選擇“<b>用戶管理</b> > <b>匯入</b>”。只有具有特定管理員許可權的用戶才有該功能。</td>
					</tr>
					<tr>
						<td nowrap="nowrap" align="center">3</td>
						<td>使用“<b>檔位置</b>”右側的“<b>瀏覽</b>...”按鈕，指定剛才填寫完成的文件。</td>
					</tr>
					<tr>
						<td nowrap="nowrap" align="center">4</td>
						<td>根據學習平台上的提示去完成操作。</td>
					...
					<tr>
						<td nowrap="nowrap" align="center">5</td>
						<td>如果文件中有多條用戶名相同的記錄，該用戶的信息將會以最後一條記錄的信息為準。</td>
					</tr>
				</table>
				<br/>
				<table width="95%" align="center" class="instr_table">
			...
			<xsl:when test="$in_lang = 'en-us'">
				<table width="95%" align="center" class="instr_table">
					<tr>
						<td class="title" width="100%" colspan="2" nowrap="nowrap">Instruction for importing user profile</td>
					</tr>
					<tr>
						<td nowrap="nowrap" align="center" width="10%">1</td>
					...
					<tr>
						<td nowrap="nowrap" align="center">2</td>
						<td>Login to the learning platform and go to <b>User Management</b> > <b>Import</b> This function is available only to users with specific administrative user role.</td>
					</tr>
					<tr>
						<td nowrap="nowrap" align="center">3</td>
					...
					<tr>
						<td nowrap="nowrap" align="center">5</td>
						<td>If there are multiple records with duplicated user ID, system will apply the change according to the last record.</td>
					</tr>
				</table>
				<br/>
				<table width="95%" align="center" class="instr_table">
