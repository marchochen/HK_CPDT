...
function get_mod_evn_param() {
	var cos_id = opener.document.frmXml.cos_id.value;
	var start_datetime = opener.document.frmXml.start_datetime.value;
	var end_datetime = opener.document.frmXml.end_datetime.value;
	var all_mod_ind = opener.document.frmXml.all_mod_ind.value;
	var all_enrolled_lrn_ind = opener.document.frmXml.all_enrolled_lrn_ind.value;
	var usr_ent_id_lst = '';
	var usr_name_lst = '';
	if(opener.document.frmXml.usr_ent_id_lst){
		usr_ent_id_lst = opener.document.frmXml.usr_ent_id_lst.value;
	}
	if(opener.document.frmXml.usr_name_lst){
		usr_name_lst = opener.document.frmXml.usr_name_lst.value;
	}
	
	var str_paramer = '';
	str_paramer = '&cos_id=' + cos_id
				+'&start_datetime=' + start_datetime
				+'&end_datetime=' + end_datetime
				+'&all_mod_ind=' + all_mod_ind
				+'&all_enrolled_lrn_ind=' + all_enrolled_lrn_ind
				+'&usr_ent_id_lst=' + usr_ent_id_lst
				+'&usr_name_lst=' + usr_name_lst;
	 return str_paramer;
}
...
function get_rpt() {
	...
	get_rpt_url = get_rpt_url + get_mod_evn_param();
	$.ajax({
		url: get_rpt_url,
...
function downloadComplete(filePath) {
	...
	document.getElementById("file_path").innerText = lab_file_link;
