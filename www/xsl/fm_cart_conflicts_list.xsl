...
<!-- ===================================================================== -->
	...
	<xsl:template name="lang_ch">
		<xsl:apply-templates>
			...
			<xsl:with-param name="lab_show_conflicts">顯示衝突</xsl:with-param>
			...
			<xsl:with-param name="lab_no_conflict">沒有預訂記錄</xsl:with-param>
	...
	<xsl:template name="lang_gb">
		<xsl:apply-templates>
			...
			<xsl:with-param name="lab_show_conflicts">显示冲突</xsl:with-param>
			...
			<xsl:with-param name="lab_no_conflict">没有预订记录</xsl:with-param>
	...
	<xsl:template name="lang_en">
		<xsl:apply-templates>
			...
			<xsl:with-param name="lab_show_conflicts">Show conflicts</xsl:with-param>
			...
			<xsl:with-param name="lab_no_conflict">No record</xsl:with-param>
	...
	<xsl:template match="fm">
		...
		<xsl:param name="lab_show_conflicts"/>
		...
		<xsl:param name="lab_no_conflict"/>
		...
		<xsl:call-template name="wb_ui_title">
			<xsl:with-param name="text"><xsl:value-of select="$lab_new_reservation"/> - <xsl:value-of select="$lab_show_conflicts"/></xsl:with-param>
		</xsl:call-template>
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<xsl:call-template name="wb_ui_show_no_item">
					<xsl:with-param name="text" select="$lab_no_conflict"/>
