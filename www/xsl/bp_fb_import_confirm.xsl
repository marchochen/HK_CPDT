...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="lang_ch">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_desc">下列是檔中的填充題。按螢幕底部的<b>確定</b> 按鈕完成匯入，或按<b>取消</b> 按鈕停止操作。</xsl:with-param>
			...
			<xsl:with-param name="lab_err_empty_blank_lines">空白的"答案欄"</xsl:with-param>
			<xsl:with-param name="lab_err_invalid_blank_order_lines">"答案欄"次序不符</xsl:with-param>
	...
	<xsl:template name="lang_gb">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_desc">下列是文件中的填空题。单击屏幕底部的<b>确定</b> 按钮完成导入，或单击<b>取消</b> 按钮停止操作。</xsl:with-param>
			...
			<xsl:with-param name="lab_err_empty_blank_lines">空白的"答案栏"</xsl:with-param>
			<xsl:with-param name="lab_err_invalid_blank_order_lines">"答案栏"排序不符</xsl:with-param>
	...
	<xsl:template name="lang_en">
		<xsl:call-template name="content">
			...
			<xsl:with-param name="lab_err_invalid_blank_order_lines">Invalid blank order</xsl:with-param>
	...
	<xsl:template name="content">
		...
		<xsl:param name="lab_err_invalid_blank_order_lines"/>
										...
										<td colspan="3">
											<span class="wbRowText">
												...
												<xsl:choose>
													...
													<xsl:when test="name() = 'invalid_resource_id'">
													...
													<xsl:when test="name() = 'invalid_blank_order_lines'">
														<xsl:value-of select="$lab_err_invalid_blank_order_lines"/>
													</xsl:when>
													<xsl:otherwise>
			...
			<xsl:otherwise>
				<xsl:choose>
					...
					<div style="overflow-x: scroll;">
						<table border="0" cellspacing="0" cellpadding="0" width="{$wb_gen_table_width}" class="wzb-ui-table">
							...
							<xsl:otherwise>
								<xsl:if test="$upload_success_cnt >= 1">
									<xsl:call-template name="wb_gen_form_button">
										...
										<xsl:with-param name="wb_gen_btn_href">javascript:Batch.Res.Import.confirm(document.frmXml,'FB')</xsl:with-param>
									</xsl:call-template>
								...
								<xsl:call-template name="wb_gen_form_button">
									...
									<xsl:with-param name="wb_gen_btn_href">
										<xsl:choose>
											...
											<xsl:otherwise>javascript:Batch.Res.Import.cancel(<xsl:value-of select="$ulg_id"/>, 'FB')</xsl:otherwise>
										</xsl:choose>
									</xsl:with-param>
								</xsl:call-template>
							</xsl:otherwise>
		...
		<xsl:choose>
			...
			<xsl:when test="@id = '4'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '1']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '5'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '1']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '6'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '2']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '7'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '2']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '8'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '3']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '9'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '3']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '10'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '4']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '11'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '4']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '12'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '5']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '13'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '5']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '14'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '6']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '15'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '6']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '16'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '7']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '17'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '7']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '18'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '8']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '19'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '8']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '20'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '9']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '21'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '9']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '22'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '10']/feedback/@condition"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			...
			<xsl:when test="@id = '23'">
				<td nowrap="nowrap" valign="top" align="center">
					<span class="wbRowText">
						<xsl:call-template name="unescape_html_linefeed">
							<xsl:with-param name="my_right_value"><xsl:value-of select="$question/outcome[@order = '10']/feedback/@score"/></xsl:with-param>
						</xsl:call-template>
					</span>
					<img src="{$wb_img_path}tp.gif" width="1" height="1" border="0"/>
				</td>
			</xsl:when>																					
			<xsl:when test="text() = 'Option 1'">
				<td nowrap="nowrap" valign="top" align="left">
					<span class="wbRowText">
					...
					<span class="wbRowText">
						<xsl:for-each select="$question/outcome/feedback">
							<xsl:if test="@score = $outcome_score">
								...
								<xsl:if test="$outcome_condition_ != $outcome_condition"><xsl:text>, </xsl:text></xsl:if>								
