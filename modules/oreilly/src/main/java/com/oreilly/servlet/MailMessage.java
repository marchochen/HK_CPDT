 ...
 * String from = "Mail Message Servlet <MailMessage@servlets.com>";
 * String to = "to@servlets.com";
 * String cc1 = "cc1@servlets.com";
 * String cc2 = "cc2@servlets.com";
 * String bcc = "bcc@servlets.com";
 * &nbsp;
